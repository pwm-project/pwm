...
<% boolean showForgottenPasswordUnlockAction = (Boolean)JspUtility.getAttribute(pageContext, PwmRequestAttribute.ForgottenPasswordShowUnlockAction); %>
...
<div id="wrapper">
    ...
    <div id="centerbody">
        ...
        <% if (showForgottenPasswordUnlockAction && !showForgottenPasswordAction) { %>
            <p><pwm:display key="Display_RecoverMinLifetimeChoices"/></p>
        <% } else if (showForgottenPasswordAction && !showForgottenPasswordUnlockAction) { %>
            <p><pwm:display key="Display_RecoverChangePassword"/></p>
        <% } else { %>
