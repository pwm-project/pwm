    ...
    <div>
        <form action="<pwm:context/>/private/admin" method="post" enctype="application/x-www-form-urlencoded"
            ...
            <table style="max-width: 700px">
                ...
                <tr class="noborder">
                    <td class="noborder">
                        <% final PwmLogLevel configuredLevel = JspUtility.getPwmRequest( pageContext ).getDomainConfig().readSettingAsEnum(PwmSetting.EVENTS_LOCALDB_LOG_LEVEL,PwmLogLevel.class); %>
