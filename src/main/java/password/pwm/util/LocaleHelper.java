...
public class LocaleHelper {
    ...
    public static ConfigLocaleStats getConfigLocaleStats() throws PwmUnrecoverableException, PwmOperationalException {
        ...
        {
            final StoredValue storedValue = PwmSetting.CHALLENGE_RANDOM_CHALLENGES.getDefaultValue(PwmSettingLdapTemplate.DEFAULT);
    ...
    private static class LocaleInfoGenerator {
        ...
        private static List<Locale> knownLocales() {
            ...
            try {
                final StringArrayValue stringArrayValue = (StringArrayValue) PwmSetting.KNOWN_LOCALES.getDefaultValue(PwmSettingLdapTemplate.DEFAULT);
