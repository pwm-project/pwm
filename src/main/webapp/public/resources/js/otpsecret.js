...
PWM_OTP.openCheckCodeDialog = function() {
    var templateHtml = '<div>'
        ...
        + '<span style="display:none;color:green" id="checkIcon" class="btn-icon pwm-icon pwm-lg pwm-check"></span>'
        + '<span style="display:none;color:red" id="crossIcon" class="btn-icon pwm-icon pwm-lg pwm-times"></span>'
        + '<span style="display:none" id="workingIcon" class="pwm-icon pwm-lg pwm-spin pwm-spinner"></span>'
        + '</td><td style="width:150px">'
        + '<button type="submit" name="button-verifyCode" class="btn" id="button-verifyCode">'
        + '<span class="btn-icon pwm-icon pwm-check"></span>' + PWM_MAIN.showString("Button_CheckCode") + '</button>'
        + '</td></tr></table></div>';
