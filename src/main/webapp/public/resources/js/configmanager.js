        ...
        var loadFunction = function(data) {
            if (data['data'] && data['data']['records']) {
                ...
                if (hasWarnTopics) {
                    ...
                    parentDiv.innerHTML = '<div id="panel-healthHeaderErrors" class="header-error"><span class="pwm-icon pwm-warning"></span> ' + PWM_ADMIN.showString('Header_HealthWarningsPresent') + '</div>';
                } else {
