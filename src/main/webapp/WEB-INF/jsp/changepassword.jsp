            ...
            <table style="border:0">
                <tr>
                    <td style="border:0;">
                        <div style="width: 100%">
                            ...
                            <pwm:if test="<%=PwmIfTag.TEST.showRandomPasswordGenerator%>">
                            &nbsp;&nbsp;
                            <div class="pwm-icon pwm-icon-retweet icon_button" id="autogenerate-icon" style="cursor: pointer; visibility: hidden" ></div>
                            </pwm:if>
                        </div>
                        <input type="<pwm:value name="<%=PwmValueTag.VALUE.passwordFieldType%>"/>" name="password1" id="password1" class="changepasswordfield passwordfield" <pwm:autofocus/>/>
                    </td>
                    <td style="border:0; width:15%">
                        <pwm:if test="<%=PwmIfTag.TEST.showStrengthMeter%>">
                ...
                <tr>
                    <td style="border:0; width:75%">
                        ...
                        <input type="<pwm:value name="<%=PwmValueTag.VALUE.passwordFieldType%>"/>" name="password2" id="password2" class="changepasswordfield passwordfield"/>
                    </td>
                    <td style="border:0; width:15%">
