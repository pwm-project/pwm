...
<div id="header-warning" style="display: none">
    ...
    <pwm:if test="showIcons"><span id="icon-configModeHelp" class="btn-icon pwm-icon pwm-question-circle"></span></pwm:if>
        <br/><br/>
    <% } else if (adminUser) { %>
    ...
    <div class="header-warning-row header-warning-buttons">
        ...
        <a class="header-warning-button" id="header_administrationButton" href="<pwm:url url="/private/admin"/>">
            <pwm:if test="showIcons"><span class="btn-icon pwm-icon pwm-list-alt"></span></pwm:if>
...
<div id="button-openHeader" title="<pwm:display key="Button_Show"/>">
    <span class="pwm-icon pwm-chevron-circle-left"></span>
</div>
<% } %>
