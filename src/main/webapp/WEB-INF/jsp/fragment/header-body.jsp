...
<div id="header">
    ...
    <div id="header-center">
        ...
        <div id="header-center-right">
            ...
            <% if (showHome) { %>
            <a class="header-button" href="<pwm:value name="<%=PwmValueTag.VALUE.homeURL%>"/>" id="HomeButton">
                <pwm:if test="<%=PwmIfTag.TEST.showIcons%>"><span class="btn-icon pwm-icon pwm-icon-home"></span></pwm:if>
            ...
            <a class="header-button" href="<pwm:url url='<%=PwmServletDefinition.Logout.servletUrl()%>' addContext="true"/>" id="LogoutButton">
                <pwm:if test="<%=PwmIfTag.TEST.showIcons%>"><span class="btn-icon pwm-icon pwm-icon-sign-out"></span></pwm:if>
