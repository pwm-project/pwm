                    ...
                    <table style="width:450px;">
                        <tr><td style="text-align: center; cursor: pointer">
                            <button id="reportStartButton" class="btn">
                                <pwm:if test="<%=PwmIfTag.TEST.showIcons%>"><span class="btn-icon pwm-icon pwm-icon-play">&nbsp;</span></pwm:if>
                                <pwm:display key="Button_Report_Start" bundle="Admin"/>
                            </button>
                            &nbsp;&nbsp;
                            <button id="reportStopButton" class="btn">
                                <pwm:if test="<%=PwmIfTag.TEST.showIcons%>"><span class="btn-icon pwm-icon pwm-icon-stop">&nbsp;</span></pwm:if>
                                <pwm:display key="Button_Report_Stop" bundle="Admin"/>
                            </button>
                            &nbsp;&nbsp;
                            <button id="reportClearButton" class="btn">
                                <pwm:if test="<%=PwmIfTag.TEST.showIcons%>"><span class="btn-icon pwm-icon pwm-icon-trash-o">&nbsp;</span></pwm:if>
