...
public class ThemeNameTag extends PwmAbstractTag {
    private static final PwmLogger LOGGER = PwmLogger.getLogger(ThemeNameTag.class);
...
// --------------------- Interface Tag ---------------------
    ...
    public int doEndTag()
        ...
        try {
            ...
            pageContext.getOut().write(themeName);
        } catch (Exception e) {
