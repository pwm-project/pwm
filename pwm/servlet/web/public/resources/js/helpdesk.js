...
PWM_HELPDESK.changePasswordPopup = function() {
    require(["dijit/Dialog"],function(){
        ...
        if (PWM_VAR['helpdesk_setting_PwUiMode'] == 'both') {
            bodyText += '<p>&nbsp;»&nbsp; <a href="#" id="helpdesk_autoGeneratePasswordButton">' + PWM_MAIN.showString('Display_AutoGeneratedPassword') + '</a></p>';
        }
        ...
        */
        PWM_MAIN.showDialog({
            ...
            loadFunction: function(){
                ...
                PWM_MAIN.addEventHandler('helpdesk_autoGeneratePasswordButton','click',function(){
                    PWM_MAIN.clearDijitWidget('changepassword-popup');
...
PWM_HELPDESK.validateOtpCode = function(userKey) {
    PWM_VAR['validateOtpCodeFunction'] = function(){
        var content = {
            userKey:userKey,
    ...
    var text = '<table class="noborder"><tr><td style="width: 100px"><input style="width: 100px" id="otpCode" name="otpCode" oninput="PWM_VAR[\'validateOtpCodeFunction\']()"/></td><td>'
        + '<span style="display:none;color:green" id="checkIcon" class="btn-icon fa fa-lg fa-check"></span>'
        + '<span style="display:none;color:red" id="crossIcon" class="btn-icon fa fa-lg fa-times"></span></td></table>';
    PWM_MAIN.showDialog({
        closable:true,
